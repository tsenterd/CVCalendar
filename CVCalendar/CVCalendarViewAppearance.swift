...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayFont: UIFont? = UIFont(name: "Avenir", size: 12)
    public var dayLabelPresentWeekdayFont: UIFont? = UIFont(name: "Avenir", size: 12)
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 12)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 12)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 12)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 12)
    public var dayLabelWeekdaySelectedFont: UIFont? = UIFont(name: "Avenir-Heavy", size: 12)
    ...
    /// Default text size.
    public var dayLabelWeekdayTextSize: CGFloat? = 12
    public var dayLabelWeekdayHighlightedTextSize: CGFloat? = 12
    public var dayLabelWeekdaySelectedTextSize: CGFloat? = 12
    public var dayLabelPresentWeekdayTextSize: CGFloat? = 12
    public var dayLabelPresentWeekdayHighlightedTextSize: CGFloat? = 12
    public var dayLabelPresentWeekdaySelectedTextSize: CGFloat? = 12
